...
from app.checks import booked as _booked  # noqa: F401  - registers the checks
from app.checks import serp as _serp  # noqa: F401  - registers the checks

__all__ = ["_onpage", "_rendered", "_speed", "_vision", "_booked"]
